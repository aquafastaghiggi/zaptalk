...
class ConversationTag(Base):
    ...
    __table_args__ = (UniqueConstraint("conversation_id", "label", name="uq_conversation_tag_label"),)
    ...
    conversation: Mapped["Conversation"] = relationship("Conversation", back_populates="tags")  # noqa
